"""
engine/signal_generator.py - Generates formatted signal messages
"""
...
from engine import perf_tracker
...
def format_signal_message(result: dict) -> str:
    """Format a signal result into a Telegram-ready message."""
    ...
    # Collect reasons from strategies that match the final signal
    reasons = []
...
def generate_all_signals(symbols: list = None) -> list[dict]:
